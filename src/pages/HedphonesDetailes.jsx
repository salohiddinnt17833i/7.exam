...
import one from '../assets/detailes/first.png'
import two from '../assets/detailes/two.png'
import three from '../assets/detailes/three.png'
      ...
      <div className='w-full bg-white'>
        <div className='w-[1110px] m-auto flex justify-between'>
          <div className='w-[540px] h-[560px] bg-[#F1F1F1] flex justify-center rounded-lg'>
            <img className='w-[350px] h-[386px] my-auto' src={headphones2} alt="" />
          </div>
          <div>
