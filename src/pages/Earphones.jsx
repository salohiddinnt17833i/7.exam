      ...
      <div className='w-full bg-white'>
        <div className='w-[1110px] m-auto pt-32 flex items-center justify-between'>
          <div className='w-[540px] h-[560px bg-[#F1F1F1] flex justify-center rounded-lg p-20'>
            <img className='w-[350px] h-[386px]' width={350} height={386} src={yx1earphones} alt="" />
          </div>
          <div>
            <div>
              ...
              <Link to={'/earphones/yx1-earphones'} className='py-3 px-6 border-none text-white bg-orange-400 hover:bg-orange-300'>SEE PRODUCT</Link>
            </div>
          </div>
        </div>
      </div>
